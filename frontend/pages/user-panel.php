                    ...
                    <div class="d-flex flex-row align-items-center mb-3">
                        <div class="me-4">
                            ...
                            <img id="userProfilePictureCard"
                                src="/trsi/uploads/<?php echo htmlspecialchars($profile_picture); ?>" alt="Profile"
                                style="width: 100px; height: 100px; border-radius: 50%; background: var(--uam-blue); object-fit: cover;">
                            <?php else: ?>
                            <div
                                style="width: 100px; height: 100px; border-radius: 50%; background: var(--uam-blue); display: flex; align-items: center; justify-content: center; color: #fff; font-weight: bold; font-size: 1.2rem;">
                                Picture
                            </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="password" class="form-control" id="modalUserCurrentPassword"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="modalUserCountry" name="country"
                                    default="Seleccione un país" required>
